...
pu AS
(
	SELECT CAST(payment_dttm AS DATE) as dt, COUNT(DISTINCT payments.user_id) AS user_count
...
dau AS 
(
	SELECT CAST(begin_dttm AS DATE) as dt, COUNT(DISTINCT sessions.user_id) AS user_count
